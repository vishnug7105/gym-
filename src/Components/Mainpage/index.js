...
I’m a great place for you to tell a story and let your users know a little more about you.</p>
    ...
    Join Base and Transform Your Body and Mind</h1>
    ...
    Excuses don’t burn calories.Excuses are for people who don’t want it bad enough.</p>
    </div>
    </div>
  ...
  Think BIG and don’t listen to people who tell you it can’t be done. Life’s too short to think small.</p>
    </div>
    </div>
    ...
    alt="model-1"
    className=" md:w-[280px] md:h-[200px] mt-4"/></div>
    <div>
    <img
    ...
    alt="model-1"
    className=" md:w-[280px] md:h-[200px] sm:w-full  mt-4"/></div>
    <div>
    <img
    ...
    alt="model-1"
    className=" md:w-[280px] md:h-[200px] mt-4 sm:w-full"/></div>
    <div>
    <img
